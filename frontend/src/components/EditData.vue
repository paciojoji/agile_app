      ...
      if (this.checkFormValidity()) {
        ...
        Swal.fire({
          ...
          if (result.isConfirmed) {
            ...
            formData.append("agile_id", _this.edit_form.agile_id);
            formData.append("title", _this.edit_form.title);
            formData.append("description", _this.edit_form.description);
            formData.append("type", _this.edit_form.type);

            try {
              let response = await axios.post("/update-agile/", formData);
